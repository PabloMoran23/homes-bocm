# Elche — investigación portal ayuntamiento

Municipio: Elche (`elche`), provincia Alicante, Comunitat Valenciana. Boletín: DOGV (`dogv`).
...
- `municipio.adapters.elche:ElcheAyuntamientoAdapter`
