# Elx — investigación portal ayuntamiento

Municipio: Elx (`elx`), provincia Elche, Comunitat Valenciana. Boletín: DOGV (`dogv`). INE: 03065 (mismo municipio que Elche/Elx).
...
- `municipio.adapters.elx:ElxAyuntamientoAdapter`
