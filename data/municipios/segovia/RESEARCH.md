...
- Dominios `segovia.es` y `sede.segovia.es` pueden bloquear conexiones desde algunos entornos cloud (connection reset); el adapter funciona en red con acceso directo.
