...
WP_BASE = "https://aguimes.es"
SEDE_BASE = "https://aguimes.sedelectronica.es"
MUNICIPIO = "Agüimes"
ID_PREFIX = "aguimes"
SITCAN_PACKAGE = "planeamiento-urbanistico-de-aguimes"
GEOBDP_MUNICIPIO = "https://geobdp.grafcan.es/core/municipios/35002/"

DEFAULT_SEED_PAGES: list[str] = [
    f"{WP_BASE}/urbanismo/",
    f"{WP_BASE}/transparencia-informacion-del-plan-municipal-de-ordenacion/",
    f"{WP_BASE}/transparencia-informacion-de-los-planes-y-proyectos-de-desarrollo-del-plan-municipal-de-ordenacion/",
    f"{WP_BASE}/modificacion-menor-no1-pgo/",
    f"{WP_BASE}/plan-especial-de-ordenacion-de-la-zona-de-servicio-del-puerto-de-arinaga/",
    f"{WP_BASE}/ordenanza-provisional-para-ordenacion-de-parcela-en-el-sector-p3-norte-del-poligono-industrial-arinaga/",
    f"{WP_BASE}/el-ayuntamiento-firmo-el-convenio-para-el-desarrollo-del-nuevo-sector-urbanistico-en-playa-de-arinaga/",
    f"{WP_BASE}/sale-a-participacion-ciudadana-la-propuesta-de-nueva-ordenanza-municipal-de-la-edificacion/",
    f"{WP_BASE}/tramites/",
]
...
RE_PDF_HREF = re.compile(
    r'href="((?:https?://(?:www\.)?aguimes\.es)?/[^"]+\.pdf[^"]*)"',
    re.I,
)
...
class AguimesAyuntamientoAdapter(AyuntamientoAdapter):
    """WordPress X Theme + SITCAN CKAN + GEOBDP Grafcan (Canarias)."""
    ...
    def _fetch(self, url: str) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-aguimes/1.0")},
        )
    ...
    def _collect_licencia_tramites(self) -> list[dict[str, Any]]:
        return [
            ...
            },
            {
                ...
                "lat": None,
                "lon": None,
                "titulo": "Urbanismo — planificación y gestión urbanística",
            ...
            },
            {
                ...
                "lat": None,
                "lon": None,
                "titulo": "Trámites municipales — licencias y autorizaciones",
