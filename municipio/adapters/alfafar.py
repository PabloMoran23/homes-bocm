...
SEDE_BASE = "https://alfafar.sedelectronica.es"
BOARD_URL = f"{SEDE_BASE}/board"
WEB_BASE = "https://www.alfafar.es"
TRANSPARENCIA_OBRAS_URL = f"{WEB_BASE}/es/transparenciadana/obras-publicas"
TRANSPARENCIA_NORMATIVA_URL = f"{WEB_BASE}/es/transparenciadana/normativa-elaboracion"
VISOR_URL = "https://visor.alfafar.es/es/"
MUNICIPIO = "Alfafar"
ID_PREFIX = "alfafar"
COD_INE_MUN = "46022"
...
RE_PREVIEW_LINK = re.compile(
    r'href="((?:https://alfafar\.sedelectronica\.es)?/preview-document/[a-f0-9-]+)"',
    re.I,
)
...
class AlfafarAyuntamientoAdapter(AyuntamientoAdapter):
    ...
    def __init__(self, slug: str, config: dict[str, Any] | None = None, base_url: str = ""):
        ...
        self.transparencia_obras_url = str(
            self.config.get("transparencia_obras_url") or TRANSPARENCIA_OBRAS_URL
        )
    ...
    def _fetch(self, url: str, *, timeout: int = 60) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-alfafar/1.0")},
        )
    ...
    def _collect_proyecto_info_pages(self) -> list[dict[str, Any]]:
        return [
            {
                "id": _stable_id("proy", self.transparencia_obras_url),
                "municipio": MUNICIPIO,
                "titulo": "Transparencia — obras públicas y urbanismo",
                "fecha": None,
                "tipo": "transparencia",
                "url": self.transparencia_obras_url,
                "source": "ayuntamiento",
                "origen": "transparencia",
                "nota": "Portal transparenciadana — obras públicas",
            },
            {
                "id": _stable_id("proy", self.transparencia_normativa_url),
                "municipio": MUNICIPIO,
                "titulo": "Transparencia — normativa urbanística elaborada",
                "fecha": None,
                "tipo": "normativa",
            ...
            },
            {
                ...
                "municipio": MUNICIPIO,
                "titulo": "Visor cartográfico municipal — visor.alfafar.es",
                "fecha": None,
                "tipo": "visor GIS",
                "url": self.visor_url,
                "source": "ayuntamiento",
                "origen": "visor",
                "nota": "Visor municipal (acceso intermitente desde CI)",
            },
            {
