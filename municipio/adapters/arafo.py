...
WEB_BASE = "https://www.arafo.es"
SEDE_BASE = "https://arafo.sedelectronica.es"
BOARD_URL = f"{SEDE_BASE}/board/"
URBANISMO_URL = f"{WEB_BASE}/urbanismo,-obras-y-vias-publicas.html"
MUNICIPIO = "Arafo"
ID_PREFIX = "arafo"
SITCAN_PACKAGE = "planeamiento-urbanistico-de-arafo"
GEOBDP_MUNICIPIO = "https://geobdp.grafcan.es/core/municipios/38004/"

DEFAULT_SEED_PAGES: list[str] = [
    URBANISMO_URL,
    f"{WEB_BASE}/tablon-electronico-de-edictos.html",
    f"{WEB_BASE}/portal-de-transparencia.html",
...
class ArafoAyuntamientoAdapter(AyuntamientoAdapter):
    """WebSite X5 (arafo.es) + sede espublico gestiona + SITCAN + GEOBDP Grafcan."""
    ...
    def _fetch(self, url: str) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-arafo/1.0")},
        )
    ...
    def _collect_licencia_tramites(self) -> list[dict[str, Any]]:
        return [
            ...
            },
            {
                ...
                "lat": None,
                "lon": None,
                "titulo": "Oficina Técnica de Urbanismo — licencias y planeamiento",
                "url": URBANISMO_URL,
                "source": "ayuntamiento",
                "origen": "tramite_informativo",
            },
