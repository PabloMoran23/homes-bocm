...
WP_BASE = "https://arenasdesanpedro.es"
WP_API = f"{WP_BASE}/wp-json/wp/v2"
SEDE_BASE = "https://arenasdesanpedro.sedelectronica.es"
MUNICIPIO = "Arenas de San Pedro"
ID_PREFIX = "arenas-de-san-pedro"

WFS_BASE = "https://idecyl.jcyl.es/geoserver/urbanismo/ows"
WFS_MUNICIPIO = "Arenas de San Pedro"
...
DEFAULT_SEED_PAGES: list[str] = [
    f"{WP_BASE}/concejalias/urbanismo-obras-y-servicios/",
    f"{WP_BASE}/concejalias/urbanismo-obras-y-servicios/solicitudes/",
    f"{WP_BASE}/concejalias/urbanismo-obras-y-servicios/inspeccion-tecnica-de-edificios/",
]

RE_PREVIEW = re.compile(
    r'href="(https://arenasdesanpedro\.sedelectronica\.es/preview-document/[^"]+)"',
    re.I,
)
...
RE_PDF_HREF = re.compile(
    r'href=["\']((?:https?://(?:www\.)?arenasdesanpedro\.es)?/wp-content/uploads/[^"\']+\.pdf[^"\']*)["\']',
    re.I,
)
...
class ArenasDeSanPedroAyuntamientoAdapter(AyuntamientoAdapter):
    """WordPress Avada (urbanismo/formularios) + sede espublico tablón + IDECyL WFS (geometría partial)."""
    ...
    def _fetch(self, url: str) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-arenas-de-san-pedro/1.0")},
        )
    ...
    def _collect_licencia_info_pages(self) -> list[dict[str, Any]]:
        pages = [
            ...
            (
                f"{WP_BASE}/concejalias/urbanismo-obras-y-servicios/solicitudes/",
                "formularios licencias y declaraciones responsables (PDF)",
            ),
            (
                f"{WP_BASE}/concejalias/urbanismo-obras-y-servicios/",
