...
SEDE_BASE = "https://arjona.sedelectronica.es"
...
RE_BOARD_NON_URBAN = re.compile(
    ...
    r"cobranza|padrones|subvencion|bolsa de empleo|plan especial de empleo|"
    r"coordinador de tiempo libre|agente de acci[oó]n juvenil|liquidaciones del padr[oó]n)",
)
RE_BOARD_ROW = re.compile(r"<tr[^>]*>\s*<td class=\"class_name\".*?</tr>", re.I | re.S)
RE_BOARD_CELL = re.compile(r'class="(class_[^"]+)"[^>]*>(.*?)</td>', re.I | re.S)
RE_PREVIEW_LINK = re.compile(
    r'href="((?:https://arjona\.sedelectronica\.es)?/preview-document/[a-f0-9-]+)"',
    re.I,
)
...
class ArjonaAyuntamientoAdapter(AyuntamientoAdapter):
    """Sede espublico gestiona (tablón + transparencia). Web www.arjona.es bloqueada por WAF."""
    ...
    def _fetch(self, url: str) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-arjona/1.0")},
        )
        ...
        rows: list[dict[str, Any]] = [
            {
                ...
                "municipio": MUNICIPIO,
                "titulo": "PGOU Arjona — consulta SITUA (Junta de Andalucía)",
                "fecha": None,
                "tipo": "PGOU",
                "url": SITUA_SEARCH,
                "source": "ayuntamiento",
                "origen": "situa",
                "nota": "Planeamiento digitalizado regional (INE 23007); sin enlace por expediente del tablón",
            },
            {
                "id": _stable_id("proy", self.transparency_url),
                "municipio": MUNICIPIO,
                "titulo": "Transparencia — Urbanismo, obras públicas y medio ambiente (sede)",
                "fecha": None,
                "tipo": "urbanismo",
                "url": self.transparency_url,
                "source": "ayuntamiento",
                "origen": "transparencia",
                "nota": "Sección 7 en portal de transparencia espublico (0 documentos publicados en sep 2026)",
            },
            {
                "id": _stable_id("proy", "https://www.arjona.es/urbanismo"),
                "municipio": MUNICIPIO,
                "titulo": "Área de urbanismo — web municipal (referencia)",
                "fecha": None,
                "tipo": "urbanismo",
                "url": "https://www.arjona.es/urbanismo",
                "source": "ayuntamiento",
                "origen": "web_ref",
                "nota": "Web corporativa con WAF anti-bot; no scrapeable desde CI",
            },
        ]
        return rows
