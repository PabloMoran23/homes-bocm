...
WEB_BASE = "https://www.arrecife.es"
SEDE_BASE = "https://arrecife.sedelectronica.es"
BOARD_URL = f"{SEDE_BASE}/board"
ORDENACION_URL = f"{WEB_BASE}/node/199"
MUNICIPIO = "Arrecife"
ID_PREFIX = "arrecife"
SITCAN_PACKAGE = "planeamiento-urbanistico-de-arrecife"
GEOBDP_MUNICIPIO = "https://geobdp.grafcan.es/core/municipios/35004/"

DEFAULT_SEED_PAGES: list[str] = [
    ORDENACION_URL,
    f"{WEB_BASE}/transparencia",
...
RE_PDF_HREF = re.compile(
    r'href="((?:https?://(?:www\.)?arrecife\.es)?/[^"]+\.pdf[^"]*)"',
    re.I,
)
...
class ArrecifeAyuntamientoAdapter(AyuntamientoAdapter):
    """Portal corporativo (transparencia/PDFs) + sede espublico + SITCAN + GEOBDP Grafcan."""
    ...
    def _fetch(self, url: str) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-arrecife/1.0")},
        )
    ...
    def _collect_licencia_tramites(self) -> list[dict[str, Any]]:
        return [
            ...
            },
            {
                ...
                "lat": None,
                "lon": None,
                "titulo": "Transparencia — ordenación del territorio (licencias y planeamiento)",
                "url": ORDENACION_URL,
                "source": "ayuntamiento",
                "origen": "tramite_informativo",
            },
