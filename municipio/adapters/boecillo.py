...
SEDE_BASE = "https://boecillo.sedelectronica.es"
WP_BASE = "https://www.boecillo.es"
...
RE_PREVIEW = re.compile(
    r'href="(https://boecillo\.sedelectronica\.es/preview-document/[^"]+)"',
    re.I,
)
RE_CATALOG = re.compile(
    r'href="((?:https://boecillo\.sedelectronica\.es)?/catalog/t/[^"]+)"[^>]*>([^<]+)</a>',
    re.I,
)
...
class BoecilloAyuntamientoAdapter(AyuntamientoAdapter):
    """Sede espublico gestiona + WP municipal + PLAI JCYL + geometría parcial IDECyL WFS."""
    ...
    def __init__(self, slug: str, config: dict[str, Any] | None = None, base_url: str = ""):
        ...
        self.wfs_municipio = str(self.config.get("wfs_municipio") or "Laguna de Duero")
    ...
    def _fetch(self, url: str, *, sede: bool = False) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-boecillo/1.0")},
        )
    ...
    def _collect_licencia_info_pages(self) -> list[dict[str, Any]]:
        pages = [
            (f"{WP_BASE}/ayuntamiento/urbanismo/", "urbanismo — trámites y visores GIS"),
            (
                "https://localgis.diputaciondevalladolid.es:8082/localgis-guiaurbana/public/selectMap.do?idEntidad=6",
                "LocalGIS guía urbana Diputación Valladolid",
            ),
            ("https://uer.diputaciondevalladolid.es/Boecillo/", "Urbanismo en red UER"),
        ]
