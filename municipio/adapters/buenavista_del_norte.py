...
WP_BASE = "https://www.buenavistadelnorte.es"
SEDE_BASE = "https://sede.buenavistadelnorte.es"
MUNICIPIO = "Buenavista del Norte"
ID_PREFIX = "bvdn"
SITCAN_PACKAGE = "planeamiento-urbanistico-de-buenavista-del-norte"
GEOBDP_MUNICIPIO = "https://geobdp.grafcan.es/core/municipios/38010/"

DEFAULT_SEED_PAGES: list[str] = [
    f"{WP_BASE}/ayuntamiento/areas-municipales/oficina-tecnica/",
    f"{WP_BASE}/noticias/2018/se-culmina-el-proyecto-de-reparcelacion-de-la-zona-industrial-de-daute-flor/",
    f"{WP_BASE}/noticias/2017/presentacion-de-la-asistencia-urbanistica-a-seis-municipios-de-la-isla/",
    f"{WP_BASE}/noticias/2021/el-ayuntamiento-de-buenavista-del-norte-obtiene-una-subvencion-de-93-mil-euros-para-la-redaccion-del-plan-de-movilidad-urbana-sostenible/",
    "https://www.idecanarias.es/resources/PLA_ENP_URB/URB_PLA/TF/Buen/457/indice.html",
]
...
RE_PDF_HREF = re.compile(
    r'href="((?:https?://(?:www\.)?buenavistadelnorte\.es)?/[^"]+\.pdf[^"]*)"',
    re.I,
)
...
class BuenavistaDelNorteAyuntamientoAdapter(AyuntamientoAdapter):
    """WordPress Divi + sede tributaria + SITCAN CKAN + GEOBDP Grafcan (Canarias)."""
    ...
    def _fetch(self, url: str) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-buenavista-del-norte/1.0")},
        )
        ...
        rows: list[dict[str, Any]] = [
            {
                ...
                "lat": None,
                "lon": None,
                "titulo": "Sede electrónica — portal de servicios tributarios",
                "url": f"{self.sede_base}/",
                "source": "ayuntamiento",
                "origen": "tramite_informativo",
            },
            {
                "id": _stable_id("lic", f"{self.sede_base}/publico/recaudacion/tasas"),
                "fecha_concesion": None,
                "tipo": "trámite informativo",
                "distrito": None,
                "lat": None,
                "lon": None,
                "titulo": "Autoliquidación — impuesto sobre construcciones, instalaciones y obras",
                "url": f"{self.sede_base}/publico/recaudacion/tasas",
                "source": "ayuntamiento",
                "origen": "tramite_informativo",
            },
            {
                "id": _stable_id("lic", f"{WP_BASE}/ayuntamiento/areas-municipales/oficina-tecnica/"),
                "fecha_concesion": None,
                "tipo": "trámite informativo",
                "distrito": None,
                "lat": None,
                "lon": None,
                "titulo": "Oficina Técnica — licencias y disciplina urbanística",
                "url": f"{WP_BASE}/ayuntamiento/areas-municipales/oficina-tecnica/",
                "source": "ayuntamiento",
                "origen": "tramite_informativo",
            },
        ]
