...
WEB_BASE = "https://www.bunyol.es"
SEDE_BASE = "https://bunyol.sede.dival.es"
MUNICIPIO = "Buñol"
ID_PREFIX = "bunol"
INE_COD_MUN = "46077"
...
URBANISME_URL = f"{WEB_BASE}/pagina/urbanismo-0"
...
RE_DOC_LINK = re.compile(
    r'href="((?:https://bunyol\.sede\.dival\.es)?/tablondeanuncios/documento\.aspx\?id=\d+[^"]*)"',
    re.I,
)
...
class BunolAyuntamientoAdapter(AyuntamientoAdapter):
    """Drupal www.bunyol.es + sede Dival (Sedipualba) tablón RSS + ICV GVA WFS partial."""
    ...
    def _fetch(self, url: str, *, timeout: int = 90) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-bunol/1.0")},
        )
        ...
        return [
            {
                ...
                "lat": None,
                "lon": None,
                "titulo": "Tablón de anuncios — sede electrónica Buñol",
                "url": self.tablon_url,
                "source": "ayuntamiento",
                "nota": "Edictos y licencias publicados en bunyol.sede.dival.es",
                "origen": "sede_tablon",
            },
            {
            ...
            },
            {
                ...
                "source": "ayuntamiento",
                "nota": "Sección urbanismo (Drupal); web www.bunyol.es puede no responder desde algunos entornos",
                "origen": "web_tramite",
            },
        ]
