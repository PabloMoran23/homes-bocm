...
WP_BASE = "https://ayuntamientodecasavieja.es"
WP_API = f"{WP_BASE}/wp-json/wp/v2"
SEDE_BASE = "https://casavieja.sedelectronica.es"
MUNICIPIO = "Casavieja"
ID_PREFIX = "casavieja"

WFS_BASE = "https://idecyl.jcyl.es/geoserver/urbanismo/ows"
WFS_MUNICIPIO = "Casavieja"
...
DEFAULT_SEED_PAGES: list[str] = [
    f"{WP_BASE}/urbanismo/",
    f"{WP_BASE}/plano/",
    f"{WP_BASE}/bandos-y-anuncios/",
    f"{WP_BASE}/autorizacion-desescombro-en-zona-urbana/",
]

RE_PREVIEW = re.compile(
    r'href="(https://casavieja\.sedelectronica\.es/preview-document/[^"]+)"',
    re.I,
)
...
RE_PDF_HREF = re.compile(
    r'href=["\']((?:https?://(?:www\.)?ayuntamientodecasavieja\.es)?/wp-content/uploads/[^"\']+\.pdf[^"\']*)["\']',
    re.I,
)
...
class CasaviejaAyuntamientoAdapter(AyuntamientoAdapter):
    ...
    def _fetch(self, url: str) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-casavieja/1.0")},
        )
    ...
    def _collect_licencia_info_pages(self) -> list[dict[str, Any]]:
        pages = [
            ...
            (f"{WP_BASE}/urbanismo/", "urbanismo — normativa y trámites sede electrónica"),
            (f"{WP_BASE}/plano/", "plano urbanístico municipal"),
            (
                "https://servicios.jcyl.es/PlanPublica/searchVPubDocMuniPlau.do?provincia=05&municipio=054",
                "PlanPublica JCyl — documentación planeamiento Casavieja",
            ),
        ]
        rows: list[dict[str, Any]] = []
