...
SEDE_BASE = "https://coin.sedelectronica.es"
...
RE_PROYECTO = re.compile(
    ...
    r"cambio de uso|sunp|supi|ordenanza|rectificaci[oó]n descriptiva)",
)
...
RE_PREVIEW_LINK = re.compile(
    r'href="((?:https://coin\.sedelectronica\.es)?/preview-document/[a-f0-9-]+)"',
    re.I,
)
...
class CoinAyuntamientoAdapter(AyuntamientoAdapter):
    """Sede espublico gestiona: tablón de anuncios (/board/). Web coin.es inaccesible."""
    ...
    def _fetch(self, url: str) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-coin/1.0")},
        )
