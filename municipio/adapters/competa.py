...
SEDE_BASE = "https://competa.sedelectronica.es"
...
RE_PREVIEW_LINK = re.compile(
    r'href="((?:https://competa\.sedelectronica\.es)?/preview-document/[a-f0-9-]+)"',
    re.I,
)
...
class CompetaAyuntamientoAdapter(AyuntamientoAdapter):
    """Sede espublico gestiona: tablón de anuncios (/board/). Web competa.es bloqueada en CI."""
    ...
    def _fetch(self, url: str) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-competa/1.0")},
        )
    ...
    def _collect_licencia_info_pages(self) -> list[dict[str, Any]]:
        return [
            ...
            {
                "id": _stable_id("lic", "https://www.competa.es/16127/autorizacion-ejecucion-de-obras"),
                "fecha_concesion": None,
                "tipo": "autorización ejecución de obras",
                "distrito": None,
                "lat": None,
                "lon": None,
                "titulo": "Autorización ejecución de obras — formulario web",
                "url": "https://www.competa.es/16127/autorizacion-ejecucion-de-obras",
                "source": "ayuntamiento",
                "nota": "Trámite informativo en web municipal (Diputación Málaga)",
                "origen": "web_tramite",
            },
            {
                "id": _stable_id("lic", "https://www.competa.es/16152/licencias-de-apertura-y-actividades-economicas"),
                "fecha_concesion": None,
                "tipo": "licencias de apertura y actividad",
                "distrito": None,
                "lat": None,
                "lon": None,
                "titulo": "Licencias de apertura y actividades económicas",
                "url": "https://www.competa.es/16152/licencias-de-apertura-y-actividades-economicas",
                "source": "ayuntamiento",
                "nota": "Formularios y modelos de solicitud en web municipal",
                "origen": "web_tramite",
            },
            {
