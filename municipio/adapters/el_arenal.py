...
WP_BASE = "https://elarenal.es"
WP_API = f"{WP_BASE}/wp-json/wp/v2"
SEDE_BASE = "https://elarenal.sedelectronica.es"
MUNICIPIO = "El Arenal"
ID_PREFIX = "el-arenal"

WFS_BASE = "https://idecyl.jcyl.es/geoserver/urbanismo/ows"
WFS_MUNICIPIO = "El Arenal"
...
DEFAULT_SEED_PAGES: list[str] = [
    f"{WP_BASE}/urbanismo/",
    f"{WP_BASE}/el-ayuntamiento/ordenanzas/",
]

RE_PREVIEW = re.compile(
    r'href="(https://elarenal\.sedelectronica\.es/preview-document/[^"]+)"',
    re.I,
)
...
RE_PDF_HREF = re.compile(
    r'href=["\']((?:https?://(?:www\.)?elarenal\.es)?/wp-content/uploads/[^"\']+\.pdf[^"\']*)["\']',
    re.I,
)
...
class ElArenalAyuntamientoAdapter(AyuntamientoAdapter):
    """WordPress Kadence (urbanismo PDFs) + sede espublico tablón + IDECyL WFS (geometría partial)."""
    ...
    def _fetch(self, url: str) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-el-arenal/1.0")},
        )
    ...
    def _collect_licencia_info_pages(self) -> list[dict[str, Any]]:
        pages = [
            ...
            (f"{WP_BASE}/urbanismo/", "urbanismo — licencias urbanísticas publicadas"),
            (f"{self.sede_base}/dossier", "sede electrónica — trámites urbanismo"),
            (
                f"{WP_BASE}/el-ayuntamiento/ordenanzas/",
                "ordenanzas — tasa actividades urbanísticas",
            ),
        ]
        rows: list[dict[str, Any]] = []
