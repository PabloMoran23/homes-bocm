...
PLANEAMIENTO_URL = (
    f"{WP_BASE}/ayuntamiento/areas-de-gobierno/planificacion-urbana-vivienda-e-infraestructuras/"
)

WFS_BASE = "https://idem.comunidad.madrid/geoserver3/ows"
WFS_TYPE = "sitcm:VPLA_V_AMBITO"
WFS_MUNICIPIO = "EL MOLAR"

RE_PREVIEW = re.compile(
    r'href="(https://elmolar\.sedelectronica\.es/preview-document/[^"]+)"',
    re.I,
)
RE_CATALOG = re.compile(
    r'href="((?:https://elmolar\.sedelectronica\.es)?/catalog/t/[^"]+)"[^>]*>([^<]+)</a>',
    re.I,
)
...
RE_PDF_HREF = re.compile(
    r'href=["\']((?:https?://(?:www\.)?elmolar\.org)?/[^"\']+\.pdf[^"\']*)["\']',
    re.I,
)
...
class ElMolarAyuntamientoAdapter(AyuntamientoAdapter):
    """WordPress (noticias + formularios) + sede espublico gestiona + ámbitos SIT WFS."""
