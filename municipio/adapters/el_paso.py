...
WP_BASE = "https://elpaso.es"
SEDE_BASE = "https://sede.elpaso.es"
MUNICIPIO = "El Paso"
ID_PREFIX = "epaso"
SITCAN_PACKAGE = "planeamiento-urbanistico-de-el-paso"
GEOBDP_MUNICIPIO = "https://geobdp.grafcan.es/core/municipios/38027/"

DEFAULT_SEED_PAGES: list[str] = [
    f"{WP_BASE}/institucion/anuncios/",
    f"{WP_BASE}/institucion/bandos/",
    f"{WP_BASE}/institucion/planes-municipales/",
    f"{WP_BASE}/institucion/otros-documentos-sede/",
    f"{WP_BASE}/eloy-martin-informa-a-los-vecinos-sobre-las-inminentes-obras-de-urbanizacion-de-la-calle-pedro-martin-hernandez/",
    f"{WP_BASE}/el-paso-finaliza-la-urbanizacion-de-la-calle-pedro-martin-hernandez-convirtiendola-en-via-estrategica-del-nuevo-casco-urbano/",
    f"{WP_BASE}/el-paso-invierte-cerca-de-un-millon-de-euros-en-el-desarrollo-urbano-de-las-calles-constitucion-y-jose-maria-brito-perez/",
]
...
RE_PDF_HREF = re.compile(
    r'href="((?:https?://(?:www\.)?elpaso\.es)?/[^"]+\.pdf[^"]*)"',
    re.I,
)
...
class ElPasoAyuntamientoAdapter(AyuntamientoAdapter):
    """WordPress Elementor + sede Maggioli + SITCAN CKAN + GEOBDP Grafcan (Canarias)."""
    ...
    def _fetch(self, url: str) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-el-paso/1.0")},
        )
