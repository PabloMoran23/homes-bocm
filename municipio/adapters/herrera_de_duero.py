...
SEDE_BASE = "https://tudeladeduero.sedelectronica.es"
WP_BASE = "https://tudeladeduero.ayuntamientosdevalladolid.es"
...
RE_PREVIEW = re.compile(
    r'href="(https://tudeladeduero\.sedelectronica\.es/preview-document/[^"]+)"',
    re.I,
)
RE_CATALOG = re.compile(
    r'href="((?:https://tudeladeduero\.sedelectronica\.es)?/catalog/t/[^"]+)"[^>]*>([^<]+)</a>',
    re.I,
)
...
class HerreraDeDueroAyuntamientoAdapter(AyuntamientoAdapter):
    """Pedanía de Tudela de Duero: sede espublico + PLAI JCYL + IDECyL WFS (municipio padre)."""
    ...
    def __init__(self, slug: str, config: dict[str, Any] | None = None, base_url: str = ""):
        ...
        self.wfs_municipio = str(self.config.get("wfs_municipio") or AYUNTAMIENTO)
    ...
    def _fetch(self, url: str, *, sede: bool = False) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-herrera-de-duero/1.0")},
        )
