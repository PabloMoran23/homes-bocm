...
WEB_BASE = "https://www.higueradelasduenas.es"
SEDE_BASE = "https://higueradelasduenas.sedelectronica.es"
MUNICIPIO = "Higuera de las Dueñas"
ID_PREFIX = "higuera-de-las-duenas"
PLAU_URL = (
    "https://servicios.jcyl.es/PlanPublica/searchVPubDocMuniPlau.do"
    "?bInfoPublica=N&pager.sortname=fPublicacion&pager.sortindex=-3&provincia=05&municipio=095"
)
...
WFS_MUNICIPIO = "Higuera de las Dueñas"
...
RE_PDF_HREF = re.compile(
    r'href=["\']((?:https?://(?:www\.)?higueradelasduenas\.es)?/docus/[^"\']+\.pdf[^"\']*)["\']',
    re.I,
)
...
class HigueraDeLasDuenasAyuntamientoAdapter(AyuntamientoAdapter):
    ...
    def _fetch(self, url: str, timeout: int = 60) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-higuera-de-las-duenas/1.0")},
        )
    ...
    def _plau_proyecto(self) -> dict[str, Any]:
        rec: dict[str, Any] = {
            ...
            "municipio": MUNICIPIO,
            "titulo": "Archivo PLAU CyL — planeamiento vigente Higuera de las Dueñas",
            "fecha": None,
            "tipo": "planeamiento",
            "url": self.plau_url,
            "source": "ayuntamiento",
