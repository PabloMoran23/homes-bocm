...
MUNICIPIO = "Huerta del Rey"
ID_PREFIX = "huerta-del-rey"
...
class HuertaDelReyAyuntamientoAdapter(AyuntamientoAdapter):
    ...
    def _fetch(self, url: str, *, sede: bool = False) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-huerta-del-rey/1.0")},
        )
