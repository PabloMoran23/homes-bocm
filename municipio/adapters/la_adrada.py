...
WP_BASE = "https://www.laadrada.es"
SEDE_BASE = "https://adrada.sedelectronica.es"
...
DEFAULT_SEED_PAGES: list[str] = [
    f"{WP_BASE}/urbanismo/",
    f"{SEDE_BASE}/board",
    f"{PLAU_BASE}/searchVPubDocMuniPlau.do?bInfoPublica=N&provincia=05&municipio=002",
    "https://idecyl.jcyl.es/siur/index.html?id=05002",
]

RE_PREVIEW = re.compile(
    r'href="(https://adrada\.sedelectronica\.es/preview-document/[^"]+)"',
    re.I,
)
...
RE_PROYECTO = re.compile(
    ...
    r"edicto|actuaci[oó]n urban|normas urban|instrumento|evaluaci[oó]n de impacto)",
)
RE_EXCLUDE = re.compile(
    r"(?i)(pleno|convocatoria|empleo|subvenci[oó]n deportiv|cert\.|ordenanza fiscal|"
    r"perfil contratante|sede electronica)",
)
...
class LaAdradaAyuntamientoAdapter(AyuntamientoAdapter):
    ...
    def _fetch(self, url: str, *, sede: bool = False) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-la-adrada/1.0")},
        )
    ...
    def _collect_licencia_info_pages(self) -> list[dict[str, Any]]:
        pages = [
            (f"{self.wp_base}/urbanismo/", "urbanismo — normativa y planeamiento"),
            ...
            (
                ...
                f"bInfoPublica=N&provincia=05&municipio=002",
