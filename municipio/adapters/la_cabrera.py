...
WP_BASE = "https://www.lacabrera.es"
SEDE_BASE = "https://lacabrera.sedelectronica.es"
MUNICIPIO = "La Cabrera"
ID_PREFIX = "la-cabrera"
WFS_TYPE = "sitcm:VPLA_V_AMBITO"
WFS_MUNICIPIO = "LA CABRERA"

DEFAULT_SEED_PAGES: list[str] = [
    f"{WP_BASE}/sede-electronica/",
    f"{WP_BASE}/tu-ayuntamiento/",
    f"{WP_BASE}/servicios-municipales/",
]

DEFAULT_LICENCIA_PDFS: list[dict[str, str]] = [
    {
        "url": f"{WP_BASE}/wp-content/uploads/2025/05/DECLARACION-RESPONSABLE-URBANISTICA-DE-OBRAS-FEB-2021.pdf",
        "titulo": "Declaración responsable urbanística de obras",
    },
    {
        "url": f"{WP_BASE}/wp-content/uploads/2025/05/Formulario-Declaracion-Responsable-Urbanistica-Actividades-LaCabrera.pdf",
        "titulo": "Declaración responsable urbanística de actividades",
    },
    {
        "url": f"{WP_BASE}/wp-content/uploads/2025/05/INSTANCIA-GENERAL.pdf",
...
RE_PROYECTO = re.compile(
    ...
    r"obra(?:s)? (?:en |de |calle)|asfalt|movilidad|transporte|"
    r"\b(?:UE|SAU|S)-[\w\d-]+\b)",
)
RE_EXCLUDE = re.compile(
    ...
    r"punto limpio|recogida podas|influencia aviar|tdt 4g)",
)
...
RE_PDF_HREF = re.compile(
    r'href="((?:https?://(?:www\.)?lacabrera\.es)?/wp-content/uploads/[^"]+\.pdf[^"]*)"',
    re.I,
)
RE_BOARD_PREVIEW = re.compile(
    r'href="(https://lacabrera\.sedelectronica\.es/preview-document/[^"]+)"',
    re.I,
)
...
class LaCabreraAyuntamientoAdapter(AyuntamientoAdapter):
    """WordPress (noticias/bandos) + sede espublico (503) + SITCM WFS (geometría partial)."""
    ...
    def _fetch(self, url: str) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-la-cabrera/1.0")},
        )
        ...
        rows: list[dict[str, Any]] = [
            {
                ...
                "source": "ayuntamiento",
                "nota": "Enlaces a sede espublico gestiona (actualmente 503)",
                "origen": "wp_sede",
            },
            {
                ...
                "url": self.board_url,
                "source": "ayuntamiento",
                "nota": "Anuncios y resoluciones (sede inaccesible agosto 2026)",
                "origen": "sede_tablon",
            },
            {
                ...
                "lat": None,
                "lon": None,
                "titulo": "Transparencia — ordenanzas municipales",
