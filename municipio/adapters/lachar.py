...
RE_PROYECTO = re.compile(
    ...
    r"actuaci[oó]n|vertido|pp1r|innovaci[oó]n)",
)
RE_BOARD_NON_URBAN = re.compile(
    ...
    r"actas tribunal|bolsa de trabajo|programa 2103|comunidad de regantes)",
)
...
class LacharAyuntamientoAdapter(AyuntamientoAdapter):
    """Sede espublico gestiona (tablón). Web lachar.es (Saga/Diputación Granada). Trámites DIPGR."""
    ...
    def _collect_licencia_info_pages(self) -> list[dict[str, Any]]:
        return [
            ...
            {
                "id": _stable_id("lic", f"{self.sede_base}/dossier#dipgr-licencia-obra"),
                "fecha_concesion": None,
                "tipo": "DIPGR — licencia de edificación y obras",
                "distrito": None,
                "lat": None,
                "lon": None,
                "titulo": "DIPGR-Solicitud de Licencia de Edificación, Obras e Instalaciones",
                "url": f"{self.sede_base}/dossier",
                "source": "ayuntamiento",
                "nota": "Trámite destacado en sede (plantilla Diputación Granada)",
                "origen": "sede_tramite",
            },
            {
                "id": _stable_id("lic", f"{self.sede_base}/dossier#dipgr-consulta-urbanistica"),
                "fecha_concesion": None,
                "tipo": "DIPGR — consulta urbanística",
                "distrito": None,
                "lat": None,
                "lon": None,
                "titulo": "DIPGR-Consulta Urbanística",
                "url": f"{self.sede_base}/dossier",
                "source": "ayuntamiento",
                "nota": "Consulta de calificación urbanística vía sede",
                "origen": "sede_tramite",
            },
            {
                "id": _stable_id("lic", "https://lachar.es/ayuntamiento/plan-de-ordenacion-urbana/"),
                "fecha_concesion": None,
                "tipo": "acceso urbanismo (web municipal)",
                "distrito": None,
                "lat": None,
                "lon": None,
                "titulo": "Plan de ordenación urbana — acceso a urbanismo en sede",
                "url": "https://lachar.es/ayuntamiento/plan-de-ordenacion-urbana/",
                "source": "ayuntamiento",
                "nota": "Página informativa PGOU/POU con enlace a sede electrónica",
                "origen": "web_tramite",
            },
            {
    ...
    def _collect_proyecto_info_pages(self) -> list[dict[str, Any]]:
        return [
            {
                "id": _stable_id("proy", "https://lachar.es/ayuntamiento/plan-de-ordenacion-urbana/"),
                "municipio": MUNICIPIO,
                "titulo": "Plan de ordenación urbana (POU/PGOU) — Ayuntamiento de Láchar",
                "fecha": "2003-03-26",
                "tipo": "planeamiento",
                "url": "https://lachar.es/ayuntamiento/plan-de-ordenacion-urbana/",
                "source": "ayuntamiento",
            ...
            },
            {
                ...
                "municipio": MUNICIPIO,
                "titulo": "PGOU Láchar — consulta SITUADIFUSION (Junta de Andalucía)",
                "fecha": "2020-10-16",
                "tipo": "planeamiento",
                "url": SITUA_SEARCH,
                "source": "ayuntamiento",
                "origen": "situadifusion",
            },
            {
                "id": _stable_id(
                    "proy",
                    "https://www.juntadeandalucia.es/boja/2020/208/69",
                ),
                "municipio": MUNICIPIO,
                "titulo": "Publicación BOJA normas urbanísticas PGOU Láchar (2020)",
                "fecha": "2020-10-16",
                "tipo": "normativa urbanística",
                "url": "https://www.juntadeandalucia.es/boja/2020/208/69",
                "source": "ayuntamiento",
                "origen": "boja",
            },
            {
                "id": _stable_id(
                    "proy",
                    "https://www.juntadeandalucia.es/boja/2022/220/3",
                ),
                "municipio": MUNICIPIO,
                "titulo": "Innovación nº 1 revisión normas subsidiarias Peñuelas (BOJA 2022)",
                "fecha": "2022-11-11",
                "tipo": "modificación planeamiento",
                "url": "https://www.juntadeandalucia.es/boja/2022/220/3",
                "source": "ayuntamiento",
                "origen": "boja",
            },
            {
