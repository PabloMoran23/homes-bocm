...
SEDE_BASE = "https://lanzahita.sedelectronica.es"
MUNICIPIO = "Lanzahíta"
ID_PREFIX = "lanzahita"
PLAU_URL = (
    "https://servicios.jcyl.es/PlanPublica/searchVPubDocMuniPlau.do"
    "?bInfoPublica=N&pager.sortname=fPublicacion&pager.sortindex=-3&provincia=05&municipio=110"
)

WFS_BASE = "https://idecyl.jcyl.es/geoserver/urbanismo/ows"
WFS_MUNICIPIO = "Lanzahíta"
...
class LanzahitaAyuntamientoAdapter(AyuntamientoAdapter):
    """Sede espublico gestiona + PLAU JCyL + IDECyL WFS (sin web corporativa propia)."""
    ...
    def _fetch(self, url: str, timeout: int = 60) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-lanzahita/1.0")},
        )
    ...
    def _plau_proyecto(self) -> dict[str, Any]:
        rec: dict[str, Any] = {
            ...
            "municipio": MUNICIPIO,
            "titulo": "Archivo PLAU CyL — planeamiento vigente Lanzahíta",
            "fecha": None,
            "tipo": "planeamiento",
            "url": self.plau_url,
            "source": "ayuntamiento",
