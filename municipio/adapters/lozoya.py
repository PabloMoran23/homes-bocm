...
WP_BASE = "https://www.lozoya.es"
WP_API = f"{WP_BASE}/wp-json/wp/v2"
SEDE_BASE = "https://lozoya.sedelectronica.es"
MUNICIPIO = "Lozoya"
ID_PREFIX = "lozoya"

WFS_BASE = "https://idem.comunidad.madrid/geoserver3/ows"
WFS_TYPE = "sitcm:VPLA_V_AMBITO"
WFS_MUNICIPIO = "LOZOYA"

DEFAULT_SEED_PAGES: list[str] = [
    f"{WP_BASE}/ordenanzas/",
    f"{WP_BASE}/descarga-de-impresos/",
...
RE_PROYECTO = re.compile(
    ...
    r"\b(?:UE|AD|AN|AI|PAU|S)-[\w\d-]+\b|manzana[s]? \d+)",
)
RE_EXCLUDE = re.compile(
    ...
    r"subvenci[oó]n.*alquiler|talleres online|video de lozoya|plusval[ií]a|"
    r"residuos urbanos|basura|estacionamiento regulado|parking casco|"
    r"aprovechamiento micol[oó]gico|quiosco|contrato obra.*parque)",
)
...
RE_BOARD_PREVIEW = re.compile(
    r'href="(https://lozoya\.sedelectronica\.es/preview-document/[^"]+)"',
    re.I,
)
...
class LozoyaAyuntamientoAdapter(AyuntamientoAdapter):
    """WordPress (ordenanzas, impresos, posts) + sede espublico + SITCM WFS (0 ámbitos)."""
    ...
    def _fetch(self, url: str) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-lozoya/1.0")},
        )
    ...
    def _collect_licencia_info_pages(self) -> list[dict[str, Any]]:
        return [
            {
                "id": _stable_id("lic", f"{self.wp_base}/descarga-de-impresos/licencia-obras"),
                ...
                "url": f"{self.wp_base}/descarga-de-impresos/",
                "pdf_url": f"{self.wp_base}/lozoya/wp-content/uploads/2021/02/licencia-obrasimpreso.pdf",
                "source": "ayuntamiento",
                "nota": "Impreso descargable en web municipal",
                "origen": "wp_tramite",
            },
            {
                "id": _stable_id("lic", f"{self.wp_base}/descarga-de-impresos/dr-urbanistica"),
                "fecha_concesion": None,
                "tipo": "declaración responsable urbanística",
                "distrito": None,
                "lat": None,
                "lon": None,
                "titulo": "Declaración Responsable urbanística — Licencia de Actividad y Funcionamiento",
                "url": f"{self.wp_base}/descarga-de-impresos/",
                "pdf_url": f"{self.wp_base}/lozoya/wp-content/uploads/2026/05/Modelo-DR-Urbanistica-Actividad-y-Funcionamiento.pdf",
                "source": "ayuntamiento",
                "origen": "wp_tramite",
            },
            {
