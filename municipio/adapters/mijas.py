...
WP_BASE = "https://www.mijas.es/portal"
MUNICIPIO = "Mijas"
ID_PREFIX = "mijas"

DEFAULT_SEED_PAGES: list[str] = [
    f"{WP_BASE}/urbanismo/derecho-a-la-informacion/",
    (
        f"{WP_BASE}/urbanismo/planes-parciales-de-ordenacion-planes-especiales-y-"
        "expedientes-de-adaptacion-al-pgou/"
    ),
    f"{WP_BASE}/urbanismo/planeamiento/",
    f"{WP_BASE}/urbanismo/licencias-de-obras-mayores/",
]
DEFAULT_LICENCIAS_URL = f"{WP_BASE}/urbanismo/licencias-de-obra-menor-concedidas-por-decreto/"
...
RE_PROYECTO = re.compile(
    ...
    r"calificaci[oó]n|divisi[oó]n en fases|uer|diligencia|acuerdo jgl)",
)
RE_BOARD_NON_URBAN = re.compile(
    r"(?i)(selecci[oó]n de personal|nombramiento|convocatoria.*empleo|"
    r"cobranza iae|padrones|bopma.*orientador|auxiliar administrativo|"
    r"polic[ií]a local|aparcamiento|abono|f[ií]sicas)",
)
...
class MijasAyuntamientoAdapter(AyuntamientoAdapter):
    """WordPress urbanismo (PDF/ZIP) + tablón espublico gestiona (mijas.sedelectronica.es)."""
        ...
        for page_url in self.seed_pages:
            ...
            for m in RE_WP_LINK.finditer(html):
                ...
                if "favicon" in href.lower():
                    continue
                if not re.search(r"(?i)wp-content/uploads|/files/adjuntos/", href):
                    continue
                if not re.search(r"(?i)\.(pdf|zip)(?:\?|$)", href):
                    continue
    ...
    def _collect_licencia_info_pages(self) -> list[dict[str, Any]]:
        return [
            ...
            },
            {
                ...
                "fecha_concesion": None,
                "tipo": "licencias obra menor (decreto)",
                "distrito": None,
                "lat": None,
                "lon": None,
                "titulo": "Licencias de obra menor concedidas por decreto",
                "url": self.licencias_url,
                "source": "ayuntamiento",
                "nota": "Listado histórico en PDF; sin coordenadas ni geometría",
