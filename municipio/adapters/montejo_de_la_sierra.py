...
WP_BASE = "https://www.montejodelasierra.net"
SEDE_BASE = "https://montejodelasierra.sedelectronica.es"
MUNICIPIO = "Montejo de la Sierra"
ID_PREFIX = "montejo-de-la-sierra"
WFS_MUNICIPIO = "MONTEJO DE LA SIERRA"

DEFAULT_SEED_PAGES: list[str] = [
    f"{WP_BASE}/normativa/",
]

LICENCIAS_URL = f"{SEDE_BASE}/citizen-service/89b9a1a7-18ab-4a39-97b4-0760fd5f5330"
LICENCIAS_PDF_URL = (
    f"{SEDE_BASE}/preview-document/cb12b067-5d92-4d1c-ab7e-04c813a9d4ef/"
)
...
RE_PREVIEW_LINK = re.compile(
    r'href="(https://montejodelasierra\.sedelectronica\.es/preview-document/[^"]+)"',
    re.I,
)
RE_WP_PDF = re.compile(
    r'href="((?:https://(?:www\.)?montejodelasierra\.net)?/wp-content/uploads/[^"]+\.pdf[^"]*)"',
    re.I,
)
...
class MontejoDeLaSierraAyuntamientoAdapter(AyuntamientoAdapter):
    """WordPress Divi + sede espublico gestiona + ámbitos SITCM WFS (UA-1..UA-13)."""
    ...
    def __init__(self, slug: str, config: dict[str, Any] | None = None, base_url: str = ""):
        ...
        self.normativa_url = str(self.config.get("normativa_url") or f"{self.wp_base}/normativa/")
        self.licencias_url = str(self.config.get("licencias_url") or LICENCIAS_URL)
        self.licencias_pdf_url = str(self.config.get("licencias_pdf_url") or LICENCIAS_PDF_URL)
    ...
    def _collect_licencia_info_pages(self) -> list[dict[str, Any]]:
        return [
            ...
            },
            {
                ...
                "source": "ayuntamiento",
                "nota": "Sección de trámites y documentación de licencias",
                "origen": "sede_licencias",
            },
            {
                "id": _stable_id("lic", self.licencias_pdf_url),
                "fecha_concesion": "2025-09-24",
                "tipo": "documento licencias urbanísticas",
                "distrito": None,
                "lat": None,
                "lon": None,
                "titulo": "Licencias Urbanísticas MONTEJO (PDF sede)",
                "url": self.licencias_pdf_url,
                "source": "ayuntamiento",
                "nota": "Documento informativo publicado en sede (sep 2025)",
                "origen": "sede_licencias_pdf",
            },
            {
                "id": _stable_id("lic", self.normativa_url),
                "fecha_concesion": None,
                "tipo": "ordenanzas y tasas licencias",
                "distrito": None,
                "lat": None,
                "lon": None,
                "titulo": "Normativa — ordenanzas fiscales y tasas licencias urbanísticas",
                "url": self.normativa_url,
                "source": "ayuntamiento",
                "nota": "Ordenanzas reguladoras de tasas de licencias urbanísticas (web municipal)",
                "origen": "normativa_web",
            },
        ]
    ...
    def backfill_licencias(self, out_jsonl: Path) -> dict[str, Any]:
        ...
        return {
            "rows": len(rows),
            "status": "ok",
            "info": sum(1 for r in rows if r.get("origen", "").startswith(("tablon", "sede", "normativa"))),
        }
    ...
    def backfill_proyectos(self, out_jsonl: Path) -> dict[str, Any]:
        ...
        return {
            ...
            "normativa": sum(1 for r in rows if r.get("origen") == "normativa_web"),
