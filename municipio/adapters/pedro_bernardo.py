...
SEDE_BASE = "https://pedrobernardo.sedelectronica.es"
PLAU_BASE = "https://servicios.jcyl.es/PlanPublica"
WFS_BASE = "https://idecyl.jcyl.es/geoserver/urbanismo/ows"
SIUR_URL = "https://idecyl.jcyl.es/siur/index.html?id=05182"
MUNICIPIO = "Pedro Bernardo"
ID_PREFIX = "pedro-bernardo"
PLAU_PROVINCIA = 5
PLAU_MUNICIPIO = 182
...
DEFAULT_SEED_PAGES: list[str] = [
    ...
    SIUR_URL,
    f"{PLAU_BASE}/searchVPubDocMuniPlau.do?bInfoPublica=N&provincia=05&municipio=182",
    f"{PLAU_BASE}/searchVPubDocMuniPlai.do?bInfoPublica=S&provincia=05&municipio=182",
]

RE_PREVIEW = re.compile(
    r'href="(https://pedrobernardo\.sedelectronica\.es/preview-document/[^"]+)"',
    re.I,
)
...
RE_PROYECTO = re.compile(
    ...
    r"balc[oó]n del ti[eé]tar|num\b|ns\b)",
)
RE_EXCLUDE = re.compile(
    r"(?i)(pleno|convocatoria|empleo|subvenci[oó]n deportiv|cert\.|ordenanza fiscal|"
    r"perfil contratante|iae|cobranza|calendario fiscal|tribut)",
)
...
def _proyecto_tipo(blob: str) -> str:
    ...
    if "plan parcial" in n or "balcón del tiétar" in n or "balcon del tietar" in n:
        return "plan parcial"
...
class PedroBernardoAyuntamientoAdapter(AyuntamientoAdapter):
    """Sede espublico + PlanPublica JCyL + IDECyL WFS (web corporativa en mantenimiento)."""
    ...
    def __init__(self, slug: str, config: dict[str, Any] | None = None, base_url: str = ""):
        ...
        self.siur_url = str(self.config.get("siur_url") or SIUR_URL)
    ...
    def _fetch(self, url: str, *, sede: bool = False) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-pedro-bernardo/1.0")},
        )
    ...
    def _collect_licencia_info_pages(self) -> list[dict[str, Any]]:
        pages = [
            (self.dossier_url, "trámites — sede electrónica"),
            (self.board_url, "tablón de anuncios — sede electrónica"),
            (self.transparency_url, "transparencia — urbanismo y obras públicas"),
            (
                f"{PLAU_BASE}/searchVPubDocMuniPlau.do?"
                f"bInfoPublica=N&provincia=05&municipio=182",
    ...
    def _siur_proyecto(self) -> dict[str, Any]:
        return {
            "id": _stable_id("proy", self.siur_url),
            "municipio": MUNICIPIO,
            "titulo": "Visor cartográfico SIUR — planeamiento urbanístico (JCyL)",
            "fecha": None,
            "tipo": "planeamiento",
            "url": self.siur_url,
            "source": "ayuntamiento",
    ...
    def backfill_proyectos(self, out_jsonl: Path) -> dict[str, Any]:
        ...
        return {
            ...
            "siur_jcyl": sum(1 for r in rows if r.get("origen") == "siur_jcyl"),
            "tablon": sum(1 for r in rows if r.get("origen") == "tablon"),
        }
