...
WP_BASE = "https://santamariadeguia.es"
SEDE_BASE = "https://santamariadeguia.sedelectronica.es"
MUNICIPIO = "Santa María de Guía"
ID_PREFIX = "smdg"
SITCAN_PACKAGE = "planeamiento-urbanistico-de-santa-maria-de-guia-de-gran-canaria"
GEOBDP_MUNICIPIO = "https://geobdp.grafcan.es/core/municipios/38038/"

DEFAULT_SEED_PAGES: list[str] = [
    f"{WP_BASE}/area-de-desarrollo-urbanismo/",
    f"{SEDE_BASE}/board",
    f"{SEDE_BASE}/dossier.10",
    f"{SEDE_BASE}/transparency/bbdc5edb-e4ef-4bd8-8799-a276fcb12f47/",
]
...
RE_PDF_HREF = re.compile(
    r'href="((?:https?://(?:www\.)?santamariadeguia\.es)?/[^"]+\.pdf[^"]*)"',
    re.I,
)
...
class SantaMariaDeGuiaAyuntamientoAdapter(AyuntamientoAdapter):
    ...
    def _fetch(self, url: str) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-santa-maria-de-guia/1.0")},
        )
    ...
    def _collect_licencia_tramites(self) -> list[dict[str, Any]]:
        rows: list[dict[str, Any]] = [
            {
                "id": _stable_id("lic", f"{self.sede_base}/dossier.10"),
                ...
                "url": f"{self.sede_base}/dossier.10",
                "source": "ayuntamiento",
                "origen": "tramite_informativo",
            },
            {
                "id": _stable_id("lic", f"{self.wp_base}/area-de-desarrollo-urbanismo/"),
                "fecha_concesion": None,
                "tipo": "trámite informativo",
                "distrito": None,
                "lat": None,
                "lon": None,
                "titulo": "Área desarrollo urbanismo — ordenanzas y formularios",
                "url": f"{self.wp_base}/area-de-desarrollo-urbanismo/",
                "source": "ayuntamiento",
                "origen": "tramite_informativo",
            },
            {
                ...
                "lat": None,
                "lon": None,
                "titulo": "Tablón de anuncios — edictos urbanísticos",
