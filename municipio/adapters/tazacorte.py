...
WEB_BASE = "https://tazacorte.es/web"
SEDE_BASE = "https://tazacorte.sedelectronica.es"
BOARD_URL = f"{SEDE_BASE}/board"
ORDENACION_URL = f"{WEB_BASE}/ordenanzas-y-reglamentos"
OBRAS_URL = f"{WEB_BASE}/obras-e-infraestructuras"
MUNICIPIO = "Tazacorte"
ID_PREFIX = "tazacorte"
SITCAN_PACKAGE = "planeamiento-urbanistico-de-tazacorte"
GEOBDP_MUNICIPIO = "https://geobdp.grafcan.es/core/municipios/38045/"
...
RE_PDF_HREF = re.compile(
    r'href="((?:https?://(?:www\.)?tazacorte\.es)?/[^"]+\.pdf[^"]*)"',
    re.I,
)
...
class TazacorteAyuntamientoAdapter(AyuntamientoAdapter):
    """WordPress Divi + sede espublico gestiona + SITCAN + GEOBDP Grafcan (La Palma)."""
    ...
    def _fetch(self, url: str) -> str:
        ...
        req = urllib.request.Request(
            url,
            headers={"User-Agent": self.config.get("user_agent", "poc-bocm-tazacorte/1.0")},
        )
    ...
    def _collect_licencia_tramites(self) -> list[dict[str, Any]]:
        return [
            ...
            },
            {
                ...
                "lat": None,
                "lon": None,
                "titulo": "Ordenanzas y reglamentos (urbanismo y licencias)",
                "url": ORDENACION_URL,
                "source": "ayuntamiento",
                "origen": "tramite_informativo",
            },
            {
                "id": _stable_id("lic", OBRAS_URL),
                "fecha_concesion": None,
                "tipo": "trámite informativo",
                "distrito": None,
                "lat": None,
                "lon": None,
                "titulo": "Obras e infraestructuras — área de planificación urbanística",
                "url": OBRAS_URL,
                "source": "ayuntamiento",
                "origen": "tramite_informativo",
            },
