-- Tipo de obra (qué se va a construir / actuar) en clasificación SIGMA.
ALTER TABLE homes.sigma_visor_expediente
  ADD COLUMN IF NOT EXISTS tipo_obra TEXT;

CREATE INDEX IF NOT EXISTS idx_homes_sigma_visor_tipo_obra
  ON homes.sigma_visor_expediente (tipo_obra)
...
-- Añade tipo_obra al payload del visor en get_sigma_ficha.
