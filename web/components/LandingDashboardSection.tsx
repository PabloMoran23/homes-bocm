...
export function LandingDashboardSection({
  ...
  return (
    <section
      className="border-y border-[var(--portal-accent-hover)] bg-[var(--portal-accent)] px-4 py-12 text-white sm:px-6 sm:py-14"
      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)] lg:items-center lg:gap-12">
          <div className="min-w-0">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#e6c3b4]">
            ...
            {statsLine ? (
              <p className="mt-4 text-sm text-white/55">{statsLine}</p>
            ) : null}
            <Link
              href="/madrid/estadisticas"
              className="mt-8 inline-flex items-center justify-center rounded-xl bg-[var(--portal-paper)] px-6 py-3.5 text-sm font-semibold text-[var(--portal-ink)] shadow-lg transition hover:bg-white"
            >
          ...
          {latestLicenciasTotal != null || topDistritos.length > 0 ? (
            <div
              ...
              aria-hidden
            >
              <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#e6c3b4]">
                Vista previa
              </p>
                ...
                <div className="mt-4 space-y-2">
                  {topDistritos.map((d, i) => (
                    <div key={d.name} className="flex items-center gap-3 text-sm">
                      ...
                      <span
                        className="h-2 max-w-[40%] shrink-0 rounded-full bg-[#e6c3b4]"
