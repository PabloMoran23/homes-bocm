...
export function LicenciasDatosNota() {
  return (
    <div
      className="mb-6 rounded-2xl border border-[var(--portal-accent)]/20 bg-[var(--portal-accent-soft)]/70 px-4 py-3.5 text-sm leading-relaxed text-[var(--portal-ink)]/80 ring-1 ring-[var(--portal-ink)]/[0.04] sm:px-5"
      role="note"
    >
      <p className="font-semibold text-[var(--portal-accent)]">Cómo leer estas cifras</p>
